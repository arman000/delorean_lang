...
module Delorean
  ...
  def _nt_formula
    start_index = index
    if node_cache[:formula].key?(index)
    ...
    if r1
      ...
      if r11
        ...
        if r12
          r14 = _nt_sp
          r13 = r14 || instantiate_node(SyntaxNode, input, index...index)
          s10 << r13
          if r13
            if (match_len = has_terminal?('=?', false, index))
      ...
      if r10
        ...
        if r17
          ...
          if r18
            r20 = _nt_sp
            r19 = r20 || instantiate_node(SyntaxNode, input, index...index)
            s16 << r19
            if r19
              if (match_len = has_terminal?('=', false, index))
                r21 = true
              ...
              if r21
                r23 = _nt_sp
                r22 = r23 || instantiate_node(SyntaxNode, input, index...index)
                s16 << r22
                if r22
                  r24 = _nt_expression
                  s16 << r24
        ...
        if r16
          ...
          if r26
            ...
            if r27
              r29 = _nt_sp
              r28 = r29 || instantiate_node(SyntaxNode, input, index...index)
              s25 << r28
              if r28
                i31 = index
                s31 = []
                ...
                r30 = r31 || instantiate_node(SyntaxNode, input, index...index)
                s25 << r30
                if r30
                  r34 = _nt_class_name
                  s25 << r34
  ...
  def _nt_class_name
    start_index = index
    if node_cache[:class_name].key?(index)
  ...
  def _nt_expression
    start_index = index
    if node_cache[:expression].key?(index)
    ...
    if r1
      ...
      if r11
        r13 = _nt_sp
        r12 = r13 || instantiate_node(SyntaxNode, input, index...index)
        s10 << r12
        if r12
          r14 = _nt_expression
          s10 << r14
      ...
      if r10
        ...
        if r16
          r18 = _nt_sp
          r17 = r18 || instantiate_node(SyntaxNode, input, index...index)
          s15 << r17
          if r17
            r19 = _nt_expression
            s15 << r19
            if r19
              r21 = _nt_sp
              r20 = r21 || instantiate_node(SyntaxNode, input, index...index)
              s15 << r20
              if r20
                ...
                if r22
                  r24 = _nt_sp
                  r23 = r24 || instantiate_node(SyntaxNode, input, index...index)
                  s15 << r23
                  if r23
                    r25 = _nt_expression
                    s15 << r25
                    if r25
                      r27 = _nt_sp
                      r26 = r27 || instantiate_node(SyntaxNode, input, index...index)
                      s15 << r26
                      if r26
                        ...
                        if r28
                          r30 = _nt_sp
                          r29 = r30 || instantiate_node(SyntaxNode, input, index...index)
                          s15 << r29
                          if r29
                            r31 = _nt_expression
                            s15 << r31
        ...
        if r15
          ...
          if r33
            r35 = _nt_sp
            r34 = r35 || instantiate_node(SyntaxNode, input, index...index)
            s32 << r34
            if r34
              r36 = _nt_binary_op
              s32 << r36
              if r36
                r38 = _nt_sp
                r37 = r38 || instantiate_node(SyntaxNode, input, index...index)
                s32 << r37
                if r37
                  r39 = _nt_expression
                  s32 << r39
  ...
  def _nt_getattr_exp
    start_index = index
    if node_cache[:getattr_exp].key?(index)
  ...
  def _nt_dotted
    start_index = index
    if node_cache[:dotted].key?(index)
  ...
  def _nt_dot_exp
    start_index = index
    if node_cache[:dot_exp].key?(index)
    ...
    if r1
      ...
      if r10
        r12 = _nt_sp
        r11 = r12 || instantiate_node(SyntaxNode, input, index...index)
        s9 << r11
        if r11
          r14 = _nt_kw_args
          r13 = r14 || instantiate_node(SyntaxNode, input, index...index)
          ...
          if r13
            r16 = _nt_sp
            r15 = r16 || instantiate_node(SyntaxNode, input, index...index)
            s9 << r15
            if r15
              if (match_len = has_terminal?(')', false, index))
                r17 = true
      ...
      if r9
        ...
        if r19
          ...
          if r20
            ...
            if r22
              ...
              if r23
                r25 = _nt_sp
                r24 = r25 || instantiate_node(SyntaxNode, input, index...index)
                s18 << r24
                if r24
                  r27 = _nt_fn_args
                  r26 = r27 || instantiate_node(SyntaxNode, input, index...index)
        ...
        if r18
          ...
          if r32
            r34 = _nt_sp
            r33 = r34 || instantiate_node(SyntaxNode, input, index...index)
            s31 << r33
            if r33
              i35 = index
              r36 = _nt_identifier
  ...
  def _nt_unpack_args
    start_index = index
    if node_cache[:unpack_args].key?(index)
  ...
  def _nt_list_expr
    start_index = index
    if node_cache[:list_expr].key?(index)
    ...
    if r1
      ...
      if r2
        ...
        if r26
          r28 = _nt_sp
          r27 = r28 || instantiate_node(SyntaxNode, input, index...index)
          s25 << r27
          if r27
            r29 = _nt_fn_args
            s25 << r29
  ...
  def _nt_set_expr
    start_index = index
    if node_cache[:set_expr].key?(index)
  ...
  def _nt_hash_expr
    start_index = index
    if node_cache[:hash_expr].key?(index)
                            ...
                            if r17
                              ...
                              if r18
                                ...
                                if r19
                                  ...
                                  if r20
                                    r22 = _nt_sp
                                    r21 = r22 || instantiate_node(SyntaxNode, input, index...index)
                                    s2 << r21
                                    if r21
                                      i24 = index
                                      s24 = []
      ...
      if r2
        ...
        if r32
          ...
          if r33
            ...
            if r35
              r37 = _nt_sp
              r36 = r37 || instantiate_node(SyntaxNode, input, index...index)
              s31 << r36
              if r36
                if (match_len = has_terminal?('}', false, index))
                  r38 = true
  ...
  def _nt_binary_op
    start_index = index
    if node_cache[:binary_op].key?(index)
  ...
  def _nt_unary_op
    start_index = index
    if node_cache[:unary_op].key?(index)
  ...
  def _nt_fn_args
    start_index = index
    if node_cache[:fn_args].key?(index)
  ...
  def _nt_hash_args
    start_index = index
    if node_cache[:hash_args].key?(index)
        ...
        if r4
          ...
          if r6
            ...
            if r15
              ...
              if r17
                r19 = _nt_sp
                r18 = r19 || instantiate_node(SyntaxNode, input, index...index)
                s14 << r18
                if r18
                  r21 = _nt_hash_args
                  r20 = r21 || instantiate_node(SyntaxNode, input, index...index)
            ...
            if r27
              ...
              if r29
                ...
                if r30
                  ...
                  r32 = r33 || instantiate_node(SyntaxNode, input, index...index)
                  s22 << r32
                  if r32
                    i40 = index
                    s40 = []
                    r42 = _nt_sp
                    r41 = r42 || instantiate_node(SyntaxNode, input, index...index)
                    s40 << r41
                    if r41
                      if (match_len = has_terminal?(',', false, index))
                        r43 = true
                      ...
                      if r43
                        r45 = _nt_sp
                        r44 = r45 || instantiate_node(SyntaxNode, input, index...index)
                        s40 << r44
                        if r44
                          r47 = _nt_hash_args
                          r46 = r47 || instantiate_node(SyntaxNode, input, index...index)
                          s40 << r46
                        end
                      end
                    end
                    ...
                    r39 = r40 || instantiate_node(SyntaxNode, input, index...index)
                    s22 << r39
                  end
                end
              end
  ...
  def _nt_kw_args
    start_index = index
    if node_cache[:kw_args].key?(index)
        ...
        if r31
          ...
          if r32
            ...
            if r34
              ...
              s42 = []
              r44 = _nt_sp
              r43 = r44 || instantiate_node(SyntaxNode, input, index...index)
              s42 << r43
              if r43
                if (match_len = has_terminal?(',', false, index))
                  r45 = true
                ...
                if r45
                  ...
                  if r46
                    r49 = _nt_kw_args
                    r48 = r49 || instantiate_node(SyntaxNode, input, index...index)
                    s42 << r48
                  end
                end
              end
  ...
  def _nt_decimal
    start_index = index
    if node_cache[:decimal].key?(index)
  ...
  def _nt_integer
    start_index = index
    if node_cache[:integer].key?(index)
  ...
  def _nt_identifier
    start_index = index
    if node_cache[:identifier].key?(index)
  ...
  def _nt_boolean
    start_index = index
    if node_cache[:boolean].key?(index)
  ...
  def _nt_nil_val
    start_index = index
    if node_cache[:nil_val].key?(index)
  ...
  def _nt_string
    start_index = index
    if node_cache[:string].key?(index)
