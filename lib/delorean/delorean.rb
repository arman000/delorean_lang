...
module Delorean
  ...
  def _nt_formula
    ...
    if s1.last
      r1 = instantiate_node(TypedFormula,input, i1...index, s1)
      r1.extend(Formula0)
    else
      @index = i1
      r1 = nil
    ...
    if r1
      ...
      if s11.last
        r11 = instantiate_node(Formula,input, i11...index, s11)
        r11.extend(Formula1)
      else
        @index = i11
        r11 = nil
      ...
      if r11
        ...
        if s19.last
          r19 = instantiate_node(SubNode,input, i19...index, s19)
          r19.extend(Formula2)
        else
          @index = i19
          r19 = nil
  ...
  def _nt_boolean
    ...
    if r1
      ...
      if r2
        ...
        if has_terminal?('TRUE', false, index)
          r3 = instantiate_node(Boolean,input, index...(index + 4))
          @index += 4
        else
          terminal_parse_failure('TRUE')
          r3 = nil
        ...
        if r3
          ...
          if has_terminal?('FALSE', false, index)
            r4 = instantiate_node(Boolean,input, index...(index + 5))
            @index += 5
          else
            terminal_parse_failure('FALSE')
            r4 = nil
  ...
  def _nt_type
    ...
    if r1
      ...
      if r2
        ...
        if has_terminal?('decimal', false, index)
          r3 = instantiate_node(SyntaxNode,input, index...(index + 7))
          @index += 7
        else
          terminal_parse_failure('decimal')
          r3 = nil
        end
        if r3
          r0 = r3
